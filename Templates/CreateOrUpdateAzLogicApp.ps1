...
param(
	...
	[Parameter(mandatory = $false)]
	[string]$EndPeakTime = '18:00',

	[Parameter(mandatory = $false)]
	[string]$TimeDifference = '+1:00',

	[Parameter(mandatory = $false)]
	[double]$SessionThresholdPerCPU = 3,
	...
	[Parameter(mandatory = $false)]
	[int]$LimitSecondsToForceLogOffUser = 3600,
	...
	[Parameter(mandatory = $true)]
	[string]$WebhookURI = "https://e20d8c2a-838e-455d-b69d-c2c7bbc3d8a3.webhook.we.azure-automation.net/webhooks?token=Qul8jx52t%2boPY3cOH8YhTlHRTovGRxyK%2fzSlGswuJ%2bI%3d",
